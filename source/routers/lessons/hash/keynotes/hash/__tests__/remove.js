...
describe('keynote hash remove:', () => {
    ...
    test('should return 204 for remove keynote by hash', async (done) => {
        const response = await server.delete('/api/lessons/1/keynotes/1').send({});
